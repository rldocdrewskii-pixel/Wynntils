...
public final class FunctionManager extends Manager {
    ...
    private void registerAllFunctions() {
        ...
        registerFunction(new LootrunFunctions.LootrunMissionRerollsFunction());
        registerFunction(new LootrunFunctions.LootrunMissionSacrificesFunction());
        ...
        registerFunction(new LootrunFunctions.LootrunOrangeBeaconIndexFunction());
        ...
        registerFunction(new LootrunFunctions.LootrunTotalRerollsFunction());
        registerFunction(new LootrunFunctions.LootrunTotalSacrificesFunction());
        registerFunction(new LootrunFunctions.LootrunTotalSacrificedPullsFunction());
